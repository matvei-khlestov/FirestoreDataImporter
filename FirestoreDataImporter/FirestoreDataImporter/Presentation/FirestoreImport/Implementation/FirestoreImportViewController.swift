//
//  FirestoreImportViewController.swift
...
final class FirestoreImportViewController: UIViewController {
    ...
    private let viewModel: FirestoreImportViewModelProtocol
    ...
    init(viewModel: FirestoreImportViewModelProtocol) {
...
private extension FirestoreImportViewController {
