...
#if DEBUG
final class FirestoreImportViewModel: DebugImportViewModelProtocol {
    
    // MARK: - Properties
    
    private(set) var state: DebugImportState {
    ...
    var onStateChange: ((DebugImportState) -> Void)?
